    ...
    <div className="country-detail">
      ...
      <div className="country-container">
        <svg width="768" height="768" viewBox="0 0 768 768">
          {/* Show the country shape ONLY if it loads successfully */}
          {!svgError ? (
            <image
              href={countrySvgUrl}
              width="768"
          ...
          {thoughts.map((thought) => {
            ...
            return (
              <g key={thought._id} transform={`translate(${scaledX}, ${scaledY}) scale(0.3)`}>
                <path d="
                M 2.849 87.151
                c -0.801 -0.801 -0.8 -2.099 0 -2.899
                l 29.441 -29.441
                c 0.8 -0.8 2.098 -0.801 2.899 0 s 0.8 2.099 0 2.899
                ...
                <path d="
                M 24.108 89.084
                c -0.8 -0.8 -0.8 -2.099 0 -2.899
                l 11.08 -11.08 c 0.8 -0.8 2.099 -0.8 2.899 0
                c 0.8 0.8 0.8 2.099 0 2.899 l -11.08 11.08 C 26.207 89.884 24.909 89.884 24.108 89.084 z"
                  fill="rgb(80,211,161)"
                />
                <path d="
                M 89.399 0.601
                c -0.53 -0.53 -1.306 -0.729 -2.025 -0.518
                L 1.475 25.207
                c -0.778 0.228 -1.348 0.891 -1.457 1.693
                c -0.086 0.642 0.136 1.278 0.582 1.724
                c 0.11 0.11 0.235 0.21 0.372 0.294
                l 25.292 15.628 c 0.436 0.269 0.956 0.365 1.459 0.27 l 21.538 -4.079 C 65.667 32.684 78.597 18.514 89.399 0.601 z"
                  fill="rgb(80,211,161)"
                />
              </g>
            );
