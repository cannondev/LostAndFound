        ...
        {thoughts.map((thought) => (
          ...
          >
            <svg width="30" height="30" viewBox="0 0 100 100">
              <path
                d="M 2.849 87.151 c -0.801 -0.801 -0.8 -2.099 0 -2.899
                l 29.441 -29.441 c 0.8 -0.8 2.098 -0.801 2.899 0 s 0.8 2.099 0 2.899 L 5.748 87.151 C 4.947 87.952 3.649 87.952 2.849 87.151 z"
                fill="rgb(80,211,161)"
              />
              <path
              ...
              />
              <path
                d="M 24.108 89.084 c -0.8 -0.8 -0.8 -2.099 0 -2.899
                l 11.08 -11.08 c 0.8 -0.8 2.099 -0.8 2.899 0 c 0.8 0.8 0.8 2.099 0 2.899 l -11.08 11.08 C 26.207 89.884 24.909 89.884 24.108 89.084 z"
                fill="rgb(80,211,161)"
              />
              <path
